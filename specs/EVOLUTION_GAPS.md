...
**Last updated**: 2026-07-11 (Wave 136b — ALL 8 STADIAL CRITERIA CLEAR. Outer membrane sprint complete (9/14 exposures closed). DF-REPORT published. footPrint composition target introduced — first protist. `graphs/footprint_composition.toml`: petalTongue + nestGate CAS + songBird drawbridge. Live scan stable: 25/26 PASS. 149 tests. primalSpring 129 scenarios / 1102 tests.)
...
**Rust validator**: darkforest v3.0 — 14 modules (8 inner + 6 outer), `--scope inner|outer|full`, `--suite observer` static surface validation. **Outer membrane live**: 25/26 PASS against primals.eco (TLS 1.3, HSTS, headers, depot, forge, DNS, mesh)
