...
**Last updated**: 2026-08-02 (workspace unification — root `Cargo.toml`, edition 2024, chrono eliminated, port constants centralized in nucleus-primals. primalSpring v0.9.39 — `8df6b3f`, 167 scenarios. 55 depot binaries, re-harvest → 56.)
**Validation baseline**: 267 PASS, 0 FAIL, 0 KNOWN_GAP (bash 5-layer) + 33 PASS Dark Forest gate. **265 Rust tests** (darkforest 149, tunnelKeeper 48+1 ignored, nucleus-deploy 49, nucleus-primals 19), coverage: darkforest 40.77%, tunnelKeeper 52.67%
