...
SONGBIRD_FEDERATION_PORT="${SONGBIRD_FEDERATION_PORT:-7700}"
SONGBIRD_PEERS="${SONGBIRD_PEERS:-eastgate@10.10.0.3:7700}"  # backbone (10G pending cable)
...
MEMBRANE_HTTP_PORT="${MEMBRANE_HTTP_PORT:-80}"
MEMBRANE_CACHE_ROOT="${MEMBRANE_CACHE_ROOT:-/var/cache/membrane/nestgate}"
MEMBRANE_LAB_CACHE_ROOT="${MEMBRANE_LAB_CACHE_ROOT:-/var/cache/membrane/lab}"
MEMBRANE_CADDYFILE="${MEMBRANE_CADDYFILE:-/etc/membrane/Caddyfile}"
MEMBRANE_ROUTING_CONFIG="${MEMBRANE_ROUTING_CONFIG:-/etc/membrane/routing_config.toml}"

# --- Routing backends ---
ROUTING_DEFAULT_BACKEND="${ROUTING_DEFAULT_BACKEND:-gate}"
ROUTING_CACHE_MAX_MB="${ROUTING_CACHE_MAX_MB:-256}"
ROUTING_PEER_THRESHOLD_MB="${ROUTING_PEER_THRESHOLD_MB:-50}"
