...
pub(crate) fn cry_07_ionic_tamper_rejection(host: &str, cfg: &CryptoConfig, results: &mut Vec<CheckResult>) {
...
pub(crate) fn cry_08_ionic_expiry_enforcement(host: &str, cfg: &CryptoConfig, results: &mut Vec<CheckResult>) {
...
pub(crate) fn cry_09_btsp_cipher_negotiation(host: &str, results: &mut Vec<CheckResult>) {
...
pub(crate) fn cry_10_btsp_null_rejection(host: &str, results: &mut Vec<CheckResult>) {
...
pub(crate) fn cry_12_cookie_signing_version(host: &str, cfg: &CryptoConfig, results: &mut Vec<CheckResult>) {
