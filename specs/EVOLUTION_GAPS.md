...
**Last updated**: 2026-07-13 (Wave 137b — CONVERGED. PUBLIC. `live.primals.eco` LIVE — petalTongue TOPO-VIS. 3-gate mesh (eastGate + sporeGate + golgi). `require-signed` depot trust active. primalSpring v0.9.36 — `818cf11`, 144 scenarios, 1,190 tests. NUCLEUS-MATRIX U/V/W defined. `bond_type` on 19 graphs. `cargo deny check` PASS 4/4.)
