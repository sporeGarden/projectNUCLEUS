...
**Last updated**: 2026-07-14 (Wave 138b — PUBLIC + SOVEREIGN. `live.primals.eco` LIVE. SoloKey CTAPHID proven. FORGEJO-PERMS permanent. wateringHole distilled (83 active docs). primalSpring v0.9.36 — `5ba12f2`, 147 scenarios, 1,133 tests. 3 items remain: HIDRAW-REPORT-ID (bearDog), NAPI-LIFECYCLE (biomeOS), SOCKET-DIR-UNIFY (biomeOS).)
