...
**Last updated**: 2026-07-10 (Wave 136 — SECURITY & EXPOSURE SPRINT. Public exposure achieved — primals.eco served by sovereign Caddy. 301 pages indexed. AI crawlers enabled. Glacial Criterion 8 added. darkforest v3.0 shipped with outer membrane scope. Triage: 3 CRITICAL, 4 HIGH, 4 MEDIUM, 3 LOW exposures. primalSpring v0.9.33 128 scenarios / 1101 tests / KNOWN_DEBT=0.)
...
**Tier 2 Science API**: `toadstool.validate` IMPLEMENTED (S325, 112 methods, 9,074 tests), `barracuda.precision.route` v0.4.0 (649 tests), biomeOS v4.31 (8,351 tests, 88% coverage). Registry at **502+ methods** (Wave 136). Pepti 100% — 34/34 builds, 0 failures, 16 binaries × 2 triples. WAN-DISPATCH-01 transport PASS (10/10, 142ms p50). DNS cutover COMPLETE — site LIVE. Public exposure sprint active. darkforest v3.0 outer membrane scope shipped (26 checks). primalSpring v0.9.33 — 128 scenarios, 1101 tests, KNOWN_DEBT=0.
